  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <p className="text-sm text-gray-500">Staff Turnover</p>
          <p className="text-3xl font-bold mt-2">8%</p>
        </div>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <p className="text-sm text-gray-500">Certifications Due</p>
          ...
          <tbody className="divide-y">
            {[1, 2, 3, 4, 5].map((item) => (
              <tr key={item} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                <td className="p-3">Staff Member Name</td>
                <td className="p-3">Property Manager</td>
                <td className="p-3">Downtown Tower</td>
